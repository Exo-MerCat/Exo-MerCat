...
def test__alias_as_host(tmp_path, instance):
    ...
    data = {
        ...
        "alias": [
            ...
            "HIP 61820,Gaia DR2 6133384959942131968,TOI-755,HD 110113,TYC 7783-2026-1",
            "HIP 61820,TOI-755,UCAC4 229-063280,WISE J124008.78-441843.3,TIC-73228647,TYC 7783-02026-1,2MASS J12400877-4418432,Gaia DR2 6133384959942131968",
            "HIP 61820,TOI-755,UCAC4 229-063280,WISE J124008.78-441843.3,TIC-73228647,TYC 7783-02026-1,2MASS J12400877-4418432,Gaia DR2 6133384959942131968",
        ],
    }
    ...
    expected_alias = "HIP 61820,TOI-755,UCAC4 229-063280,WISE J124008.78-441843.3,TIC-73228647,TYC 7783-02026-1,2MASS J12400877-4418432,Gaia DR2 6133384959942131968,TIC 73228647,TYC 7783-2026-1"
...
def test__check_binary_mismatch(tmp_path, instance):
    ...
    expected_output = [
        ...
        "2  GJ 229 A c  GJ 229      c  S-type  wrongcoord WARNING, Coordinate Mismatch (potential_binary_mismatch 1) RA: [92.644231, 92.643599, 111.0] DEC:[-21.864642, -21.867723, 111.0] \n",
        "91 Aqr\n",
        "         name    host letter binary    catalog\n",
        "3  91 Aqr A b  91 Aqr      b      A  Catalog 1\n",
        "4    91 Aqr b  91 Aqr      b         Catalog 3 WARNING, Coordinate Mismatch (potential_binary_mismatch 1) RA: [10.0, 20.0] DEC:[40.0, 50.0] \n",
        "\n",
        "****host+letter THAT ARE INCONSISTENTLY LABELED (Potential Mismatch 2). They could be complex systems. If not, they should be treated manually in replacements.ini ****\n",
        "\n",
        "HD 202206\n",
        "               name       host letter binary catalog\n",
    ...
    data = pd.DataFrame(
        {
            ...
            "alias": [
                ...
                "2MASS J23593607-3501530,Gaia DR2 2312679845530628096,TIC 183532609,TIC-183532609,TOI-191,TYC 7522-00505-1,UCAC4 275-215468,WDS J23596-3502,WISE J235936.16-350153.1",
                "HD 147869,o Her",
    ...
    expected = pd.DataFrame(
        {
            ...
            "aliasbinary": [
                ...
                "2MASS J23593607-3501530 A,Gaia DR2 2312679845530628096 A,TIC 183532609 A,TIC-183532609 A,TOI-191 A,TYC 7522-00505-1 A,UCAC4 275-215468 A,WDS J23596-3502 A,WISE J235936.16-350153.1 A",
            ...
            "aliasbinary2": [
                ...
                "2MASS J23593607-3501530A,Gaia DR2 2312679845530628096A,TIC 183532609A,TIC-183532609A,TOI-191A,TYC 7522-00505-1A,UCAC4 275-215468A,WDS J23596-3502A,WISE J235936.16-350153.1A",
                "HD 147869AB,o HerAB",
    ...
    expected_data = pd.DataFrame(
        {
            ...
            "list_id": [
                "HIP 64426,AP J13121982+1731016,Gaia DR3 3937211745905473024,TIC 138172859,SBC9 2406,LSPM J1312+1731,TYC 1454-315-1,ASCC  868467,2MASS J13121982+1731016,USNO-B1.0 1075-00258599,AG+17 1351,AGKR 11813,BD+18  2700,Ci 20  766,Ci 18 1695,FK5 5165,G  63-9,GC 17881,GCRV  7854,GEN# +1.00114762,HD 114762,HIC  64426,LFT  980,LHS  2693,LTT 13819,N30 3028,NLTT 33242,PM 13099+1747,PPM 129656,SAO 100458,SKY# 24417,SPOCS  555,TD1 16696,UBV   11938,UBV M  19151,YZ  17  4855,YZC 18  4855,uvby98 100114762,WISEA J131219.31+173101.6,Gaia DR1 3937211741607576576,WEB 11388,WDS J13123+1731A,HD 114762A,** PAT   47A,Gaia DR2 3937211745904553600",
                ...
                "IDS 19392+5017 AB,CCDM J19418+5031AB,WDS J19418+5032AB,*  16 Cyg,ADS 12815 AB,** STFA   46,IRAS 19404+5024,IRAS F19404+5024",
                "",
            ],
            "main_id_ra": [
                198.082254,
...
def test__simbad_list_alias_search(tmp_path, instance):
    data = pd.DataFrame(
        {
            ...
            "alias": [
                ...
                "2MASS J1207,2MASS J1207-39,2MASS J12073346-3932539,2MASS J1207B,2MASS1207-3932 B,2MASSW J1207334-393254,Gaia DR2 3459372646830687104,TIC 102076870,TWA 27b",
            ],
            "main_id": ["", ""],
            "list_id": ["", ""],
            "main_id_ra": ["", ""],
    ...
    with LogCapture() as log:
        ...
        log = pd.DataFrame(list(log), columns=["user", "info", "message"])
        assert (
            "WARNING, MULTIPLE ALIASES NOT IN AGREEMENT alias ['2MASS J12073346-3932539', 'TWA 27b'] main_id ['TWA 27', 'TWA 27B']"
            in log["message"].tolist()
        )
    ...
    expected_data = pd.DataFrame(
        {
            ...
            "list_id": [
                "GJ 882,Gaia DR3 2835207319109249920,TIC 139298196,PLX 5568,LSPM J2257+2046,TYC 1717-2193-1,ASCC  826013,2MASS J22572795+2046077,USNO-B1.0 1107-00589893,*  51 Peg,AG+20 2595,BD+19  5036,CSV 102222,GC 32003,GCRV 14411,GEN# +1.00217014,HD 217014,HIC 113357,HIP 113357,HR  8729,JP11  3558,LTT 16750,N30 5052,NLTT 55385,NSV 14374,PPM 114985,ROT  3341,SAO  90896,SKY# 43603,SPOCS  990,TD1 29480,UBV M  26734,UBV   19678,YPAC 218,YZ   0  1227,YZ  20  9382,uvby98 100217014,Gaia DR2 2835207319109249920,PLX 5568.00,IRAS 22550+2030,AKARI-IRC-V1 J2257280+204608,NAME Helvetios,WEB 20165,** RBR   21A,WDS J22575+2046A",
                "** CVN   12A,2MASS J12073346-3932539,2MASSW J1207334-393254,DENIS J120733.4-393254,Gaia DR2 3459372646830687104,Gaia DR3 3459372646830687104,HIDDEN NAME 2M1207,HIDDEN NAME 2M1207A,TIC 102076870,TWA 27,TWA 27A,USNO-B1.0 0504-00258166,WDS J12076-3933A,WISE J120733.42-393254.2,WISEA J120733.41-393254.2",
            ],
...
def test__get_host_info_from_simbad(instance):
    ...
    expected_output = {
        "list_id": [
            "LTT 15751,*  16 Cyg B,** STF 4046B,ADS 12815 B,AG+50 1408,AKARI-IRC-V1 J1941518+503102,ASCC  271120,BD+50  2848,CCDM J19418+5031B,GC 27285,GCRV 12084,GEN# +1.00186427,GJ 765.1 B,HD 186427,HIC  96901,HIP 96901,HR  7504,IDS 19392+5017 B,KIC 12069449,LSPM J1941+5031E,2MASS J19415198+5031032,NLTT 48138,PPM  37673,ROT  2840,SAO  31899,SKY# 36807,SPOCS  855,TIC 27533327,TYC 3565-1525-1,UBV   16780,UBV M  24082,USNO-B1.0 1405-00322540,USNO 890,WDS J19418+5032B,WEB 17005,WISEA J194151.82+503102.2,YZ  50  6150,Gaia DR3 2135550755683407232,Gaia DR2 2135550755683407232,Gaia DR1 2135550854464294784",
            "CD-35 16019A,** B 2511A,CCDM J23596-3502A,CD-35 16019,CPC 18 12094,CPD-35  9465,GSC 07522-00505,IDS 23544-3535 A,2MASS J23593607-3501530,PPM 304426,SAO 214901,SPOCS 3245,TIC 183532609,TOI-191,TYC 7522-505-1,UCAC2  16954660,UCAC3 110-468375,UCAC4 275-215468,WASP-8,WDS J23596-3502A,Gaia DR3 2312679845530628096,Gaia DR2 2312679845530628096,Gaia DR1 2312679841235149440",
            "* o Her,*  21 Her,AG+07 2044,BD+07  3164,FK5 1429,GC 22058,GCRV  9437,GEN# +1.00147869,GSC 00381-01598,HD 147869,HIC  80351,HIP 80351,HR  6111,2MASS J16241083+0656534,N30 3675,PMC 90-93  1008,PPM 162584,Renson 41690,SAO 121568,SBC7   573,SBC9 901,SKY# 29573,TD1 19139,TIC 369080491,TYC  381-1598-1,UBV   21316,UBV M  21407,uvby98 100147869,WEB 13596,YZ   7  7306,Gaia DR2 4439556480967874432,Gaia DR3 4439556480967874432,Gaia DR1 4439556476666646528",
            "LTT  1515,*  94 Cet,** HJ  663A,ADS  2406 A,AG-01  300,AKARI-IRC-V1 J0312465-011146,BD-01   457,CCDM J03128-0112A,CSI-01   457  1,CSI-01   457  3,CSI-01   457  2,FK5  116,GC  3838,GCRV  1775,GEN# +1.00019994,GJ 128,HD  19994,HIC  14954,HIP 14954,HR   962,IDS 03077-0134 A,IRAS 03102-0122,2MASS J03124644-0111458,N30  656,NLTT 10224,PLX  663,PMC 90-93    84,PPM 175267,ROT   431,SAO 130355,SKY#  4813,SPOCS  155,TD1  1984,TIC 49845357,TYC 4708-1423-1,UBV    3104,UCAC3 178-9414,UCAC4 445-004277,uvby98 100019994,WDS J03128-0112A,WEB  2887,WISEA J031246.58-011146.4,YZ  91   684,YZ   0  3372,[RHG95]   572,Gaia DR3 3265335443260522112,Gaia DR2 3265335443260522112",
            "2MASS J16171898-2437186,EPIC 203868608,TIC 98231712,UGCS J161718.97-243718.7,WISEA J161718.97-243718.9,Gaia DR2 6049656638390048896,Gaia DR3 6049656638390048896",
...
def test__get_coordinates_from_simbad(tmp_path, instance):
    ...
    with LogCapture() as log:
        ...
        assert (
            "After coordinate check on SIMBAD at tolerance 1.0 arcsec, the residuals are: 1. Maximum angular separation: 0.45601200000000003"
            in log.actual()[-1][-1]
        )
    # import re
    ...
    expected = pd.DataFrame(
        {
            ...
            "alias": [
                "2MASS J20260027-4855132,Gaia DR2 6668227036766532864,TIC-100263315,TOI-6775,UCAC4 206-182296,WISE J202600.26-485513.4",
...
def test__merge_into_single_entry(instance, tmp_path):
    ...
    data = {
        ...
        "alias": [
            "1SWASP J133501.94-173012.7,2MASS J13350194-1730124,EPIC 212300977,Gaia DR2 3603529272750802560,TIC 294301883,TIC-294301883,TOI-774,TYC 6125-00113-1,TYC 6125-113-1,UCAC4 363-065216,WASP-55 A,WISE J133501.96-173012.7",
            "1SWASP J133501.94-173012.7,2MASS J13350194-1730124,EPIC 212300977,Gaia DR2 3603529272750802560,TIC 294301883,TIC-294301883,TOI-774,TYC 6125-00113-1,TYC 6125-113-1,UCAC4 363-065216,WASP-55 A,WISE J133501.96-173012.7",
            "1SWASP J133501.94-173012.7,2MASS J13350194-1730124,EPIC 212300977,Gaia DR2 3603529272750802560,TIC 294301883,TIC-294301883,TOI-774,TYC 6125-00113-1,TYC 6125-113-1,UCAC4 363-065216,WASP-55 A,WISE J133501.96-173012.7",
            "1SWASP J133501.94-173012.7,2MASS J13350194-1730124,EPIC 212300977,Gaia DR2 3603529272750802560,TIC 294301883,TIC-294301883,TOI-774,TYC 6125-00113-1,TYC 6125-113-1,UCAC4 363-065216,WASP-55 A,WISE J133501.96-173012.7",
            "1SWASP J133501.94-173012.7,2MASS J13350194-1730124,EPIC 212300977,Gaia DR2 3603529272750802560,TIC 294301883,TIC-294301883,TOI-774,TYC 6125-00113-1,TYC 6125-113-1,UCAC4 363-065216,WASP-55 A,WISE J133501.96-173012.7",
        ...
        "final_alias": [
            "GALAH 150429002601133,Gaia DR3 3603529272750802560,TOI-774,RAVE J133502.0-173012,RAVE J133502.0-173013,TIC 294301883,Gaia DR2 3603529272750802560,WASP-55,TYC 6125-113-1,2MASS J13350194-1730124,1SWASP J133501.94-173012.7,EPIC 212300977,Gaia DR1 3603529272750802560",
            "GALAH 150429002601133,Gaia DR3 3603529272750802560,TOI-774,RAVE J133502.0-173012,RAVE J133502.0-173013,TIC 294301883,Gaia DR2 3603529272750802560,WASP-55,TYC 6125-113-1,2MASS J13350194-1730124,1SWASP J133501.94-173012.7,EPIC 212300977,Gaia DR1 3603529272750802560",
            "GALAH 150429002601133,Gaia DR3 3603529272750802560,TOI-774,RAVE J133502.0-173012,RAVE J133502.0-173013,TIC 294301883,Gaia DR2 3603529272750802560,WASP-55,TYC 6125-113-1,2MASS J13350194-1730124,1SWASP J133501.94-173012.7,EPIC 212300977,Gaia DR1 3603529272750802560",
            "GALAH 150429002601133,Gaia DR3 3603529272750802560,TOI-774,RAVE J133502.0-173012,RAVE J133502.0-173013,TIC 294301883,Gaia DR2 3603529272750802560,WASP-55,TYC 6125-113-1,2MASS J13350194-1730124,1SWASP J133501.94-173012.7,EPIC 212300977,Gaia DR1 3603529272750802560",
            "GALAH 150429002601133,Gaia DR3 3603529272750802560,TOI-774,RAVE J133502.0-173012,RAVE J133502.0-173013,TIC 294301883,Gaia DR2 3603529272750802560,WASP-55,TYC 6125-113-1,2MASS J13350194-1730124,1SWASP J133501.94-173012.7,EPIC 212300977,Gaia DR1 3603529272750802560,extraalias",
        ],
        "main_id_ra": [
            203.75814077726,
            203.75814077726,
    ...
    for data, expected in macro_tuple:
        instance.data = data
        result = instance.merge_into_single_entry(data, "WASP-55", "", "b")
    ...
    instance.data = test6_data
    result = instance.merge_into_single_entry(test6_data, "WASP-55", "", "b")
    ...
    with open("Logs/merge_into_single_entry.txt") as f:
        ...
        test7_expected["duplicate_flag"] = [1]
        ...
        instance.data = test7_data
        result = instance.merge_into_single_entry(test7_data, "WASP-55", "", "b")
...
def test__group_by_letter_check_period(tmp_path, instance):
    ...
    case4_expected["duplicate_flag"] = [0, 0]
