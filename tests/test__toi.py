...
def test__uniform_catalog(instance):
    ...
    expected_result={ 'tid': [146589986,149601557],
         'toi': [1032.01, 1033.01],
         'toipfx': [ 1032,1033],
         'tfopwg_disp': ['PC','FP'],
         'ra': [159.221506, 87.282586],
        ...
        'letter':['.01','.01'],
            'alias':['2MASS J10365315-4232299,Gaia DR2 5392041345156957696,TIC-146589986,TOI 1032,TOI-1032,TYC 7718-01074-1,UCAC4 238-048613,WISE J103653.13-423229.8' ,'2MASS J05490779-6029549,Gaia DR2 4758940969330786432,TIC-149601557,TOI 1033,TOI-1033,TYC 8892-01686-1,UCAC4 148-006443,WISE J054907.80-602954.5'],
            'alias_vizier':['UCAC4 238-048613,2MASS J10365315-4232299,WISE J103653.13-423229.8,Gaia DR2 5392041345156957696,,,TYC 7718-01074-1','UCAC4 148-006443,2MASS J05490779-6029549,WISE J054907.80-602954.5,Gaia DR2 4758940969330786432,,,TYC 8892-01686-1'],
    ...
    for col in ['tid', 'toi', 'toipfx', 'tfopwg_disp', 'ra', 'dec',  'toi_created', 'catalog', 'TOI', 'TIC_host', 'TOI_host', 'TIC_host2', 'TOI_host2', 'host', 'letter', 'alias', 'name', 'catalog_name',  'discovery_year', 'discovery_method', 'reference']:
        assert (instance.data[col]==expected_df[col]).all()
    for col in ['p', 'p_max', 'p_min', 'pl_orbperlim',
                    'pl_rade', 'pl_radeerr1', 'pl_radeerr2', 'pl_radelim', 'mass',
                    'mass_min', 'mass_max', 'msini', 'msini_min', 'msini_max', 'a', 'a_min', 'a_max', 'e', 'e_min',
                    'e_max', 'i', 'i_min', 'i_max', 'Age (Gyrs)', 'Age_max', 'Age_min', 'Mstar', 'Mstar_max',
                    'Mstar_min', 'r', 'r_min', 'r_max']:
