...
if len(emc[emc.mass.isna()]) != len(
        emc[(emc.mass.isna()) & (emc.mass_max.isna()) & (emc.mass_min.isna()) & (emc.mass_url.isna())]):
...
if len(emc[emc.msini.isna()]) != len(
        emc[(emc.msini.isna()) & (emc.msini_max.isna()) & (emc.msini_min.isna()) & (emc.msini_url.isna())]):
...
if len(emc[~emc.bestmass.isna()]) != len(
        emc[~(emc.bestmass.isna()) & ~(emc.bestmass_max.isna()) & ~(emc.bestmass_min.isna()) & ~(
